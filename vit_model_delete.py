'''
NOTE: this contains the implementation of the vision transformer as for the pytorch vision transformer model.
Source code taken from: https://github.com/pytorch/vision/blob/main/torchvision/models/vision_transformer.py

A pythorch lighning implementation of Vision Transformer (ViT) for image classification can be found here:
